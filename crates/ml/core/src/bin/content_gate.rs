...
//! `knowledge_ml_core::checker` engine (thresholds from
//! `knowledge_ml_core::profiles`, on-disk config at
...
use knowledge_ml_core::checker::{self, EngineReport};
use knowledge_ml_core::profiles::ProfileSet;
