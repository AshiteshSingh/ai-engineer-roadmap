...
use crate::udemy::embed;
use crate::udemy::generate::prompts;
use crate::udemy::generate::quality::{check_quality, Quality};
use crate::udemy::generate::retrieve::{format_grounding, ground};
...
mod tests {
    use super::*;
    use crate::udemy::generate::quality::check_quality;
