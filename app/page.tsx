...
export default async function HomePage() {
  // "Phase 5 · Long-Term Memory" is now a real taxonomy category (assigned
  // per-slug via LESSON_CATEGORY_OVERRIDES), so it arrives in `groups` at its
  // sortOrder — no synthetic injection needed.
